# Agent Instructions for Datasynthesizer

## Project Context
Datasynthesizer is an open source Generate synthetic training data for agent testing.

## Repository Layout
- `src/aumai_datasynthesizer/` — package source
